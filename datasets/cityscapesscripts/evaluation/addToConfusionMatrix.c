...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "cityscapesscripts.evaluation.addToConfusionMatrix",
        "sources": [
...
extern int __pyx_module_is_main_cityscapesscripts__evaluation__addToConfusionMatrix;
...
static const char __pyx_k_cityscapesscripts_evaluation_add[] = "cityscapesscripts/evaluation/addToConfusionMatrix.pyx";
static const char __pyx_k_ndarray_is_not_Fortran_contiguou[] = "ndarray is not Fortran contiguous";
static const char __pyx_k_numpy_core_umath_failed_to_impor[] = "numpy.core.umath failed to import";
static const char __pyx_k_Format_string_allocated_too_shor_2[] = "Format string allocated too short.";
static const char __pyx_k_cityscapesscripts_evaluation_add_2[] = "cityscapesscripts.evaluation.addToConfusionMatrix";
...
static PyObject *__pyx_kp_s_cityscapesscripts_evaluation_add;
static PyObject *__pyx_n_s_cityscapesscripts_evaluation_add_2;
...
static PyObject *__pyx_f_17cityscapesscripts_10evaluation_20addToConfusionMatrix_tonumpyarray(unsigned PY_LONG_LONG *__pyx_v_data, unsigned PY_LONG_LONG __pyx_v_size) {
  ...
  /* "cityscapesscripts/evaluation/addToConfusionMatrix.pyx":20
 * 
 * cdef tonumpyarray(unsigned long long* data, unsigned long long size):
 * 	if not (data and size >= 0): raise ValueError             # <<<<<<<<<<<<<<
 * 	return np.PyArray_SimpleNewFromData(2, [size, size], np.NPY_UINT64, <void*>data)
 ...
 */
  ...
  /* "cityscapesscripts/evaluation/addToConfusionMatrix.pyx":21
 * cdef tonumpyarray(unsigned long long* data, unsigned long long size):
 * 	if not (data and size >= 0): raise ValueError
 * 	return np.PyArray_SimpleNewFromData(2, [size, size], np.NPY_UINT64, <void*>data)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("cityscapesscripts.evaluation.addToConfusionMatrix.tonumpyarray", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "cityscapesscripts/evaluation/addToConfusionMatrix.pyx":24
 * 
 * @cython.boundscheck(False)
...
/* Python wrapper */
static PyObject *__pyx_pw_17cityscapesscripts_10evaluation_20addToConfusionMatrix_1cEvaluatePair(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_17cityscapesscripts_10evaluation_20addToConfusionMatrix_1cEvaluatePair = {"cEvaluatePair", (PyCFunction)__pyx_pw_17cityscapesscripts_10evaluation_20addToConfusionMatrix_1cEvaluatePair, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_17cityscapesscripts_10evaluation_20addToConfusionMatrix_1cEvaluatePair(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("cityscapesscripts.evaluation.addToConfusionMatrix.cEvaluatePair", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_r = __pyx_pf_17cityscapesscripts_10evaluation_20addToConfusionMatrix_cEvaluatePair(__pyx_self, __pyx_v_predictionArr, __pyx_v_groundTruthArr, __pyx_v_confMatrix, __pyx_v_evalLabels);
...
static PyObject *__pyx_pf_17cityscapesscripts_10evaluation_20addToConfusionMatrix_cEvaluatePair(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_predictionArr, PyArrayObject *__pyx_v_groundTruthArr, PyArrayObject *__pyx_v_confMatrix, CYTHON_UNUSED PyObject *__pyx_v_evalLabels) {
  ...
  /* "cityscapesscripts/evaluation/addToConfusionMatrix.pyx":32
 ...
 */
  ...
  /* "cityscapesscripts/evaluation/addToConfusionMatrix.pyx":33
 * 
 * 	predictionArr_c  = np.ascontiguousarray(predictionArr , dtype=np.uint8    )
 * 	groundTruthArr_c = np.ascontiguousarray(groundTruthArr, dtype=np.uint8    )             # <<<<<<<<<<<<<<
 * 	confMatrix_c     = np.ascontiguousarray(confMatrix    , dtype=np.ulonglong)
 ...
 */
  ...
  /* "cityscapesscripts/evaluation/addToConfusionMatrix.pyx":34
 * 	predictionArr_c  = np.ascontiguousarray(predictionArr , dtype=np.uint8    )
 * 	groundTruthArr_c = np.ascontiguousarray(groundTruthArr, dtype=np.uint8    )
 * 	confMatrix_c     = np.ascontiguousarray(confMatrix    , dtype=np.ulonglong)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cityscapesscripts/evaluation/addToConfusionMatrix.pyx":36
 * 	confMatrix_c     = np.ascontiguousarray(confMatrix    , dtype=np.ulonglong)
 * 
 * 	cdef np.uint32_t height_ui     = predictionArr.shape[1]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cityscapesscripts/evaluation/addToConfusionMatrix.pyx":37
 * 
 * 	cdef np.uint32_t height_ui     = predictionArr.shape[1]
 * 	cdef np.uint32_t width_ui      = predictionArr.shape[0]             # <<<<<<<<<<<<<<
 * 	cdef np.uint32_t confMatDim_ui = confMatrix.shape[0]
 ...
 */
  ...
  /* "cityscapesscripts/evaluation/addToConfusionMatrix.pyx":38
 * 	cdef np.uint32_t height_ui     = predictionArr.shape[1]
 * 	cdef np.uint32_t width_ui      = predictionArr.shape[0]
 * 	cdef np.uint32_t confMatDim_ui = confMatrix.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cityscapesscripts/evaluation/addToConfusionMatrix.pyx":40
 * 	cdef np.uint32_t confMatDim_ui = confMatrix.shape[0]
 * 
 * 	addToConfusionMatrix(&predictionArr_c[0,0], &groundTruthArr_c[0,0], height_ui, width_ui, &confMatrix_c[0,0], confMatDim_ui)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cityscapesscripts/evaluation/addToConfusionMatrix.pyx":42
 * 	addToConfusionMatrix(&predictionArr_c[0,0], &groundTruthArr_c[0,0], height_ui, width_ui, &confMatrix_c[0,0], confMatDim_ui)
 * 
 * 	confMatrix = np.ascontiguousarray(tonumpyarray(&confMatrix_c[0,0], confMatDim_ui))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cityscapesscripts/evaluation/addToConfusionMatrix.pyx":44
 * 	confMatrix = np.ascontiguousarray(tonumpyarray(&confMatrix_c[0,0], confMatDim_ui))
 * 
 * 	return np.copy(confMatrix)             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_cityscapesscripts_evaluation_add, __pyx_k_cityscapesscripts_evaluation_add, sizeof(__pyx_k_cityscapesscripts_evaluation_add), 0, 0, 1, 0},
  {&__pyx_n_s_cityscapesscripts_evaluation_add_2, __pyx_k_cityscapesscripts_evaluation_add_2, sizeof(__pyx_k_cityscapesscripts_evaluation_add_2), 0, 0, 1, 1},
 ...
 */
  ...
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(4, 0, 10, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cityscapesscripts_evaluation_add, __pyx_n_s_cEvaluatePair, 24, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_cityscapesscripts__evaluation__addToConfusionMatrix) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cityscapesscripts.evaluation.addToConfusionMatrix")) {
      if (unlikely(PyDict_SetItemString(modules, "cityscapesscripts.evaluation.addToConfusionMatrix", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "cityscapesscripts/evaluation/addToConfusionMatrix.pyx":3
 ...
 */
  ...
  /* "cityscapesscripts/evaluation/addToConfusionMatrix.pyx":6
 * cimport cython
 * cimport numpy as np
 * import ctypes             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cityscapesscripts/evaluation/addToConfusionMatrix.pyx":8
 * import ctypes
 * 
 * np.import_array()             # <<<<<<<<<<<<<<
 * 
 ...
 *                    np.ndarray[np.uint64_t, ndim=2] confMatrix      ,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_17cityscapesscripts_10evaluation_20addToConfusionMatrix_1cEvaluatePair, NULL, __pyx_n_s_cityscapesscripts_evaluation_add_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_cEvaluatePair, __pyx_t_1) < 0) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "cityscapesscripts/evaluation/addToConfusionMatrix.pyx":1
 * # cython methods to speed-up evaluation             # <<<<<<<<<<<<<<
 * 
 * import numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cityscapesscripts.evaluation.addToConfusionMatrix", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cityscapesscripts.evaluation.addToConfusionMatrix");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
